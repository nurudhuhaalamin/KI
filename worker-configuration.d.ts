/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6931b0cb75e1f423c7cfbb906f9d808c)
// Runtime types generated with workerd@1.20260730.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	BERKAS: R2Bucket;
	DB: D1Database;
	NAMA_KAWASAN: "Kawasan Industri Contoh (Pratinjau)" | "Kawasan Industri Contoh";
	LOKALE_BAWAAN: "id";
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		BERKAS: R2Bucket;
		DB: D1Database;
		NAMA_KAWASAN: "Kawasan Industri Contoh (Pratinjau)";
		LOKALE_BAWAAN: "id";
		BETTER_AUTH_SECRET: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NAMA_KAWASAN" | "LOKALE_BAWAAN" | "BETTER_AUTH_SECRET">> {}
}
